...
const futureDate = new Date(tempYear, tempMonth, tempDay + 95, 24, 68, 0);
  ...
  if (
    ...
    mainContainer.innerHTML =
      `<div class="countdown-end" style="display: flex; flex-direction: column; gap: 20px;">
        ...
        <a href="https://www.frontendmentor.io/solutions/launch-countdown-timer-fCOZ7dvQvV" class="create-link"> View Solution on FEM </a>
