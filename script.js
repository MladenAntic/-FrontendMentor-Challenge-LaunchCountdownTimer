  ...
  if (
    ...
    mainContainer.innerHTML =
      `<div class="countdown-end" style="display: flex; flex-direction: column; gap: 20px;">
        <a href="https://www.frontendmentor.io/profile/MladenAntic" class="create-link"> View Solution Code </a>
        <a href="https://www.frontendmentor.io/profile/MladenAntic" class="create-link"> View Solution on FEM </a>
